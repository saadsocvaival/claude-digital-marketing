# Eval — 10-campaign-brief

## Input fixture
`clients/_fixture_devtools_saas/ledger.md` (and related artifacts — read as needed per skill).

Specific prompt to the skill:
> Using the fixture client context, produce the 10-campaign-brief artifact following its template. Self-score using the matching rubric.
