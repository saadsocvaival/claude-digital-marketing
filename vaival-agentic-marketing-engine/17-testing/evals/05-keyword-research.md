# Eval — 05-keyword-research

## Input fixture
`clients/_fixture_devtools_saas/ledger.md` (and related artifacts — read as needed per skill).

Specific prompt to the skill:
> Using the fixture client context, produce the 05-keyword-research artifact following its template. Self-score using the matching rubric.
